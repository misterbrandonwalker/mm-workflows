...
outputs:
  ...
  use_clustering_filter_out:
    ...
    type: boolean
    outputBinding:
      outputEval: ${return inputs.use_clustering_filter}
  ...
  centroid_cutoff_out:
    ...
    type: float
    outputBinding:
      outputEval: ${return inputs.centroid_cutoff}
  ...
  samples_per_complex_out:
    ...
    type: int
    outputBinding:
      outputEval: ${return inputs.samples_per_complex}
